...
pub fn get() -> Vec<Pattern> {
    vec![
        Pattern {
            ...
            min_entropy: None,
            description: "Detects Docker run or Dockerfile with --cap-add=ALL or cap_add: - ALL"
                .to_string(),
            reference: None,
            tags: vec![
                "container".to_string(),
        ...
        Pattern {
            ...
            confidence: "high".to_string(),
            min_entropy: None,
            description: "Detects Docker socket mount which can give container full Docker access"
                .to_string(),
            reference: None,
            tags: vec![
                "container".to_string(),
        ...
        Pattern {
            ...
            confidence: "high".to_string(),
            min_entropy: None,
            description: "Detects Dockerfile or Docker run with user set to root or UID 0"
                .to_string(),
            reference: None,
            tags: vec![
                "container".to_string(),
