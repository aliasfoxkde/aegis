...
pub fn get() -> Vec<Pattern> {
    vec![
        ...
        Pattern {
            ...
            reference: Some("https://pipenv.pypa.io/en/latest/pipfile.html".to_string()),
        ...
        Pattern {
            ...
            reference: Some("https://pipenv.pypa.io/en/latest/pipfile.html#pipfile-lock".to_string()),
        ...
        Pattern {
            ...
            reference: Some("https://doc.rust-lang.org/cargo/guide/cargo-toml-vs-cargo-lock.html".to_string()),
        ...
        Pattern {
            ...
            tags: vec!["dotnet".to_string(), "nuget".to_string(), "package-manager".to_string()],
            env_var: false,
            binary: false,
            exclude: None,
            file_extensions: Vec::new(),
        ...
        Pattern {
            ...
            tags: vec!["dotnet".to_string(), "packages".to_string(), "dependencies".to_string()],
            env_var: false,
            binary: false,
            exclude: None,
            file_extensions: Vec::new(),
        ...
        Pattern {
            ...
            tags: vec!["dotnet".to_string(), "project".to_string(), "msbuild".to_string()],
            env_var: false,
            binary: false,
            exclude: None,
            file_extensions: Vec::new(),
