...
`update_bundle` installs either the embedded rule set (670 patterns across 34 categories) or a bundle loaded from a sandboxed path, and reports the installed `pattern_count`.
