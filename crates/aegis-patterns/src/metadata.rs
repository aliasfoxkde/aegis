...
pub fn get() -> Vec<Pattern> {
    vec![
        ...
        Pattern {
            ...
            confidence: "high".to_string(),
            min_entropy: None,
            description: "Detects IDE configuration files that may contain sensitive settings".to_string(),
            reference: None,
        ...
        Pattern {
            ...
            category: "metadata".to_string(),
            match_pattern: r#"\.(DS_Store|Thumbs\.db|desktop\.ini|\.AppleDouble|\.LSOverride)$"#.to_string(),
            enabled: true,
            severity: "low".to_string(),
            confidence: "high".to_string(),
            min_entropy: None,
            description: "Detects operating system cache files that may contain metadata".to_string(),
            reference: None,
